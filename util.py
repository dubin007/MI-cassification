...
def load_physionet_data(subject_id, num_classes=2, long_edge=False):
    ...
    base_path = "D:/liman/db-cnn-eeg/data/files/S%03d/S%03dR%02d.edf"
    ...
    for i_run, current_run in enumerate(MI_RUNS):
        ...
        for annotation in annotations:
            ...
            action = int(annotation[2][1]) - 48  # todo
            ...
            if action == 0 and current_event[1] != 0:
                ...
                # todo
                current_event[3] = current_event[2] + TRIAL_LENGTH * SAMPLE_RATE
...
load_physionet_data(2, num_classes=4, long_edge=False)